...
// In displayArray(), you can keep the bar width at 100/array.length% 
// or slightly less to account for the small margin.
function displayArray() {
    ...
    for (let i = 0; i < array.length; i++) {
      ...
      // Fill up container without leftover space
